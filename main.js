...
var $author$project$Main$initialWidgetStyle = $mdgriffith$elm_style_animation$Animation$style(
	_List_fromArray(
		[
...
var $author$project$Main$emptyCmd = F2(
	function (a, b) {
		return _Utils_Tuple2(
			a(b),
			$elm$core$Platform$Cmd$none);
...
var $author$project$Main$fadeInAnimation = $mdgriffith$elm_style_animation$Animation$interrupt(
	_List_fromArray(
		[
			A2($author$project$Main$paddingTop, 300, 100)
		]));
var $author$project$Main$fadeOutAnimation = $mdgriffith$elm_style_animation$Animation$interrupt(
	_List_fromArray(
		[
...
var $author$project$Main$openCardAnimation = $mdgriffith$elm_style_animation$Animation$interrupt(
	_List_fromArray(
		[
			A2(
			$mdgriffith$elm_style_animation$Animation$toWith,
