...
var $mdgriffith$elm_style_animation$Animation$paddingTop = function (_v0) {
	var val = _v0.a;
	var len = _v0.b;
	return A3(
		$mdgriffith$elm_style_animation$Animation$length,
...
var $author$project$Main$init = function (flag) {
	var initialWidgetStyle = $mdgriffith$elm_style_animation$Animation$style(
		_List_fromArray(
			[
				...
				$mdgriffith$elm_style_animation$Animation$paddingTop(
	...
	return _Utils_Tuple2(
		{
			...
			cards: _List_fromArray(
				[
					{image: 'image', index: 0, name: 'name', style: initialWidgetStyle, url: 'http://www.localhost/wp-content/uploads/2020/01/music-for-13-chakras-cover-1.jpg'},
					{image: 'image', index: 1, name: 'name', style: initialWidgetStyle, url: 'http://www.localhost/wp-content/uploads/2017/07/kaart-Kyron-facebook.jpg'},
					{image: 'image', index: 2, name: 'name', style: initialWidgetStyle, url: 'http://www.localhost/wp-content/uploads/2019/11/remedies.png'},
					{image: 'image', index: 3, name: 'name', style: initialWidgetStyle, url: 'http://www.localhost/wp-content/uploads/2019/11/remedies.png'},
					{image: 'image', index: 4, name: 'name', style: initialWidgetStyle, url: 'http://www.localhost/wp-content/uploads/2019/11/remedies.png'},
					{image: 'image', index: 5, name: 'name', style: initialWidgetStyle, url: 'http://www.localhost/wp-content/uploads/2019/11/remedies.png'},
					{image: 'image', index: 6, name: 'name', style: initialWidgetStyle, url: 'http://www.localhost/wp-content/uploads/2019/11/remedies.png'}
				]),
...
var $author$project$Main$emptyCmd = F3(
	function (a, b, c) {
		return _Utils_Tuple2(
			A2(a, b, c),
			$elm$core$Platform$Cmd$none);
...
var $author$project$Main$paddingTop = F2(
	function (speed, pixels) {
		return A2(
			$mdgriffith$elm_style_animation$Animation$toWith,
			$mdgriffith$elm_style_animation$Animation$speed(
				{perSecond: speed}),
			_List_fromArray(
				[
					$mdgriffith$elm_style_animation$Animation$paddingTop(
					$mdgriffith$elm_style_animation$Animation$px(pixels))
				]));
	});
var $author$project$Main$fadeInAnimation = function (i) {
	return $mdgriffith$elm_style_animation$Animation$interrupt(
		_List_fromArray(
			[
				A2($author$project$Main$paddingTop, 300, 100)
			]));
};
var $author$project$Main$fadeOutAnimation = function (i) {
	return $mdgriffith$elm_style_animation$Animation$interrupt(
		_List_fromArray(
			[
				A2($author$project$Main$paddingTop, 500, 100),
				A2($author$project$Main$paddingTop, 500, 0)
			]));
};
...
var $author$project$Main$onStyle = F2(
	function (styleFn, card) {
		var _v0 = styleFn(card.style);
		var newCard = _v0.a;
		var cmd = _v0.b;
		return _Utils_Tuple2(
			_Utils_update(
	...
	function (model, index, fn) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{cards: a}),
			$elm$core$Platform$Cmd$batch(b));
	});
var $author$project$Main$openCardAnimation = function (i) {
	return $mdgriffith$elm_style_animation$Animation$interrupt(
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$mdgriffith$elm_style_animation$Animation$scale(3.0)
					]))
			]));
};
...
var $author$project$Main$pullAndFlipAnimation = function (i) {
	return $mdgriffith$elm_style_animation$Animation$interrupt(
		_List_fromArray(
			[
				A2($author$project$Main$paddingTop, 400, 300),
				$mdgriffith$elm_style_animation$Animation$Messenger$send(
				$author$project$Main$ShowCard(i))
			]));
};
var $author$project$Main$setCardClickedTrue = function (model) {
	return _Utils_update(
		model,
		{cardClicked: true});
};
		...
		switch (msg.$) {
			case 'ShowCard':
				...
				var _v1 = A3(
					...
					model,
					i,
					A2($author$project$Main$emptyCmd, $author$project$Main$openCardAnimation, i));
				var a = _v1.a;
				var b = _v1.b;
				return _Utils_Tuple2(
			...
			case 'FadeIn':
				...
				return A3(
					...
					model,
					i,
					A2($author$project$Main$emptyCmd, $author$project$Main$fadeInAnimation, i));
			case 'FadeOut':
				var i = msg.a;
				return A3(
					$author$project$Main$onCardStyle,
					model,
					i,
					A2($author$project$Main$emptyCmd, $author$project$Main$fadeOutAnimation, i));
			case 'PullAndFlipCard':
				...
				var _v2 = A3(
					...
					model,
					i,
					A2($author$project$Main$emptyCmd, $author$project$Main$pullAndFlipAnimation, i));
				var a = _v2.a;
				var b = _v2.b;
				return _Utils_Tuple2(
					$author$project$Main$setCardClickedTrue(a),
					b);
			default:
				var time = msg.a;
				var _v3 = $elm$core$List$unzip(
					A2(
						$elm$core$List$map,
						$author$project$Main$onStyle(
							$mdgriffith$elm_style_animation$Animation$Messenger$update(time)),
						model.cards));
				var a = _v3.a;
				var b = _v3.b;
				return _Utils_Tuple2(
...
var $author$project$Main$cardClosedView = function (card) {
	return A2(
		$elm$html$Html$img,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$src('http://www.localhost/wp-content/uploads/2015/11/LOGO-2.jpg'),
				$elm$html$Html$Attributes$width(200),
				$elm$html$Html$Attributes$height(200),
				A2($elm$html$Html$Attributes$style, 'z-index', '2006'),
				A2($elm$html$Html$Attributes$style, 'transform', 'rotate(12deg)'),
				A2($elm$html$Html$Attributes$style, 'top', '0em'),
				A2($elm$html$Html$Attributes$style, 'border', '3px solid black')
			]),
		_List_Nil);
};
var $author$project$Main$cardOpenView = function (card) {
	return A2(
		$elm$html$Html$img,
		_List_fromArray(
			[
...
var $author$project$Main$FadeIn = function (a) {
	return {$: 'FadeIn', a: a};
};
var $author$project$Main$FadeOut = function (a) {
	return {$: 'FadeOut', a: a};
};
var $author$project$Main$PullAndFlipCard = function (a) {
	return {$: 'PullAndFlipCard', a: a};
};
...
var $author$project$Main$basicCardStyle = function (card) {
	return _Utils_ap(
		$mdgriffith$elm_style_animation$Animation$render(card.style),
		_List_fromArray(
			[
...
var $author$project$Main$viewCard = function (card) {
	return A2(
		$elm$html$Html$li,
		_Utils_ap(
			$author$project$Main$basicCardStyle(card),
			_List_fromArray(
				[
		...
		_List_fromArray(
			[
				$author$project$Main$cardClosedView(card)
			]));
};
var $author$project$Main$viewChosenCard = F2(
